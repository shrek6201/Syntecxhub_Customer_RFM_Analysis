...
Clean a raw transactional dataset, compute RFM metrics per customer, segment customers into behaviorally meaningful groups, and translate those segments into targeted marketing recommendations in an interactive dashboard.
